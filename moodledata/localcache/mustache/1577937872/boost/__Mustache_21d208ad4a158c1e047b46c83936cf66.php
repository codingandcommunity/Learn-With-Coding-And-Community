...
class __Mustache_21d208ad4a158c1e047b46c83936cf66 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section15688f94702f0bfd9bdc220d78c81305($context, $indent, $value);
        }
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionE56a591f54e0e9d7ee5f76548e0f26e3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section15688f94702f0bfd9bdc220d78c81305(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
{{/element.checked}}';
            ...
            foreach ($values as $value) {
                ...
                // 'element.checked' section
                $value = $context->findDot('element.checked');
                $buffer .= $this->sectionE56a591f54e0e9d7ee5f76548e0f26e3($context, $indent, $value);
                $context->pop();
            }
        }

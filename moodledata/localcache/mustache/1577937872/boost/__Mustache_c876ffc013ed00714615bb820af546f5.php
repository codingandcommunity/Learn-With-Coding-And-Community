...
class __Mustache_c876ffc013ed00714615bb820af546f5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block51ef12b3b53d04c667d667d5f094a652'),
            ));
...
';
    ...
    public function block51ef12b3b53d04c667d667d5f094a652($context)
    {
        $indent = $buffer = '';

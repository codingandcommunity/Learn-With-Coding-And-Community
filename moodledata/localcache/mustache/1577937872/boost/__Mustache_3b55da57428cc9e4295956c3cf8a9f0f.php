...
class __Mustache_3b55da57428cc9e4295956c3cf8a9f0f extends Mustache_Template
{
...
';
        // 'showemojipicker' section
        $value = $context->find('showemojipicker');
        $buffer .= $this->section5f081f267f8a49071115a4b6fe26017d($context, $indent, $value);
...
';
    ...
    private function section5f081f267f8a49071115a4b6fe26017d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
